...
<header id="header" class="header fixed-top d-flex align-items-center">
  ...
  <main id="main" class="main">
    ...
    <div class="card-body">
          @if($errors->has('nom'))
    <p>Le nom existe déjà dans la base</p>
@endif

@if($errors->has('tel'))
    <p>Le numéro de Téléphone existe déjà</p>
@endif
...
@endif
        ...
        <h5 class="card-title">FORMULAIRE FOURNISSEUR</h5>
        <form method="post" action="{{ route('fournisseur_create') }}" enctype="multipart/form-data">
        ...
        @method('post')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="adresseFournisseur" name="prenom" >
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="telephoneFournisseur" class="form-label">Téléphone du fournisseur</label>
                <input type="text" class="form-control" id="telephoneFournisseur" name="tel" required>
            </div>
            <div class="mb-3">
                <label for="telephoneFournisseur" class="form-label">ADRESSE</label>
                <input type="text" class="form-control" id="telephoneFournisseur" name="adresse" >
            </div>
