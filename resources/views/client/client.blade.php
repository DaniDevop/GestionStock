...
<header id="header" class="header fixed-top d-flex align-items-center">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>NOMBRES DES CLIENTS : {{$clientNumber}}</h1>
      <nav>
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">LISTES DES CLIENTS</h5>
                <button ><a class="btn btn-primary" href="{{route('clients_vue')}}" >AJOUTER UN CLIENT +</a></button>
               <table class="table datatable">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>{{$user->email}}</td>
                    <td>{{$user->adresse}}</td>
                    <td><a href="{{ route('modification.vue', ['id' => $user->id]) }}" class="btn btn-danger"><i class="bi bi-pencil-square"></i></a></td>
                  </tr>
                  @endforeach
                </tbody>
              </table>
