...
<body>
    <div class="report-container">
        ...
        <div class="report-content">
            ...
            <p>Nombre de produit ajouté  notamment: {{$produitCount}}</p>
            ...
            <ul>
                <li>Designation :{{$ventes->designation}} | Prix : {{$ventes->prix_marchande}}  | Quantité vendue: {{$ventes->totalSales}}</li>
            </ul>
            @endforeach
            <p>----------------------------------------------------------------------------</p>
           ...
           @foreach($fournisseur as $fourn)
            ...
            <ul>
                ...
                <li>somme-rentré  Par des factures:  {{ $fact->sommes_produits}} FCFA</li>
                 @endforeach
            </ul>
        </div>
             ...
             <p>Sommes sortie :{{$sommeSortie}}</p>
               @foreach($sommeBenefice as $somme)
                <p>Bénéfice des produits en stock :{{$somme->somme_benefice}}</p>
              @endforeach
